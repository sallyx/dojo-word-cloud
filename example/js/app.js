require([
	...
	function (parser, Memory, Cloud) {
	    ...
	    cloud.startup();
	    var cloud = new Cloud({store: store, positionFce: 'rows', shuffle:1});
	    cloud.placeAt('rows');
	    cloud.startup();
		/*
	    var cloud = new Cloud({store: store, animation: 'translate', height: null, positionFce: 'brick', verticalChance: 0, shuffle: 1});
	    cloud.placeAt('brick');
	    cloud.startup();
		*/
	}
